...

{
  ...
  "unit_states": [{"seq": 1, "unit_name": "部队名", "status": "deploying|marching|engaging|retreating|routing", "location": "所在地名或null", "direction": "进攻方位或null", "direction_target": "攻击目标地名/部队名或null", "description": "一句话战术动作描述"}],
  "scale": "tactical|battle|strategic|null"
}
